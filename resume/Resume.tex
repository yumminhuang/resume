...
\begin{body}
	...
	\begin{itemize}[noitemsep,topsep=0pt]
		\item Managed Gerrit cluster, which hosts about 1TB codebase, for providing service to over 1500 developers
		\item Established ELK stack that collecting logs from Gerrit cluster, and provide log analysis and decision support
