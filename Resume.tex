...
\begin{body}
	...
	\begin{itemize}
		...
		% 	\item Made AWS security uplift to follow CIS benchmarks;
		% 	\item PCI-DSS complaince for legacy platform.
		% \end{itemize}
		\item \project{A welfare system of Singapore GovTech}{Sept. 2019 --- Dec. 2019} \textbf{DevOps Specialist}
		\begin{itemize}[noitemsep,topsep=0pt]
