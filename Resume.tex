...
\begin{body}
	...
	\begin{itemize}[noitemsep,topsep=0pt]
		\item \project{Legacy Payment Gateway in Australian}{Feb. 2020 --- Now} \textbf{DevOps Tech Lead}
		\begin{itemize}[noitemsep,topsep=0pt]
		...
		\end{itemize}
		\item \project{System of Singapore Goverment}{Sept. 2019 --- Dec. 2019} \textbf{DevOps Specialist}
		\begin{itemize}[noitemsep,topsep=0pt]
